...
function renderBotRow(input = 'alpha') {
  ...
  const context = {
    ...
    $botWorkspaceProfile: atom(null),
    $studioFleetCody: atom({ state: 'idle' }),
    $ccdWorker: atom({ state: 'idle' }),
    ...
    haptic: () => undefined,
    leaveGroupChatForBot: () => undefined,
    closeStudioFleetCodyWorkspace: () => undefined,
    openStudioFleetCodyWorkspace: () => false,
    closeCcdWorkspace: () => undefined,
    openCcdWorkspace: () => false,
